...
namespace LeoEducation.Api.Migrations
{
    ...
    [Migration("20260912081712_AddRecruitment")]
    partial class AddRecruitment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeoEducation.Api.Models.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("JobId", "Email")
                        .IsUnique();

                    b.ToTable("JobApplications", (string)null);
                });

            modelBuilder.Entity("LeoEducation.Api.Models.RecruitmentJob", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("LeoEducation.Api.Models.JobApplication", b =>
                {
                    b.HasOne("LeoEducation.Api.Models.RecruitmentJob", null)
                        .WithMany()
                        .HasForeignKey("JobId")
